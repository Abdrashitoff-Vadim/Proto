...
func (x *JsPlusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JsPlusRequest) ProtoMessage() {}

func (x *JsPlusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_core_core_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JsPlusRequest.ProtoReflect.Descriptor instead.
func (*JsPlusRequest) Descriptor() ([]byte, []int) {
	return file_core_core_proto_rawDescGZIP(), []int{2}
}

func (x *JsPlusRequest) GetA() string {
	if x != nil {
		return x.A
	}
	return ""
...
func (x *JsPlusRequest) GetB() string {
	if x != nil {
		return x.B
	}
	return ""
...
func (x *JsPlusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JsPlusResponse) ProtoMessage() {}

func (x *JsPlusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_core_core_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JsPlusResponse.ProtoReflect.Descriptor instead.
func (*JsPlusResponse) Descriptor() ([]byte, []int) {
	return file_core_core_proto_rawDescGZIP(), []int{3}
}

func (x *JsPlusResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
const file_core_core_proto_rawDesc = "" +
	"\n" +
	"\x0fcore/core.proto\x12\x04core\"(\n" +
	"\n" +
	"SumRequest\x12\f\n" +
	...
	"\rJsPlusRequest\x12\f\n" +
	"\x01a\x18\x01 \x01(\tR\x01a\x12\f\n" +
	"\x01b\x18\x02 \x01(\tR\x01b\"(\n" +
	"\x0eJsPlusResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\tR\x06result2k\n" +
	"\x04Core\x12.\n" +
	"\aSumFunc\x12\x10.core.SumRequest\x1a\x11.core.SumResponse\x123\n" +
	"\x06JsPlus\x12\x13.core.JsPlusRequest\x1a\x14.core.JsPlusResponseB\x10Z\x0e/corev1;corev1b\x06proto3"
...
var file_core_core_proto_goTypes = []any{
	...
	(*JsPlusRequest)(nil),  // 2: core.JsPlusRequest
	(*JsPlusResponse)(nil), // 3: core.JsPlusResponse
}
var file_core_core_proto_depIdxs = []int32{
	0, // 0: core.Core.SumFunc:input_type -> core.SumRequest
	2, // 1: core.Core.JsPlus:input_type -> core.JsPlusRequest
	1, // 2: core.Core.SumFunc:output_type -> core.SumResponse
	3, // 3: core.Core.JsPlus:output_type -> core.JsPlusResponse
